...
public class WalkingEnemySpawner : MonoBehaviour
{
    ...
    private static WalkingEnemySpawner _instance;
    public static WalkingEnemySpawner Instance
    {
        get => _instance;
        private set
        {
            ...
            {
                Debug.Log($"{nameof(WalkingEnemySpawner)} instance already exists, destroy the duplicate!");
                Destroy(value);
            }
        }
    }
